<div>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <x-input class="my-2 w-64" type="text" placeholder="Cerca per nome, codice, gruppo" wire:model="searchWorksheet"
                 x-model="newArticle"/>
                ...
                <table class="w-full text-sm text-center text-gray-500 dark:text-gray-400">
                    ...
                    @foreach ($worksheets as $worksheet)
                        <tr class="border-b border-gray-700">
                            <th scope="row"
                                class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-gray-200">1</th>
...
{{--                                                class="w-full mb-2 focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">--}}
