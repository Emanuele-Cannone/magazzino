        ...
        <div class="relative overflow-x-auto">
            <table class="w-full text-sm text-center text-gray-500 dark:text-gray-400">
                ...
                <tr>
                    ...
                    @canany(['Modifica Ruolo','Elimina Ruolo'])
                ...
                @foreach ($roles as $role)
                    ...
                    >
                        <th scope="row"
                            class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-gray-200">{{ $role->name}}</th>
                        @canany(['Modifica Ruolo','Elimina Ruolo'])
                            <td class="px-6 py-4 flex items-center justify-center">
                                @can('Modifica Ruolo')
                                    <a href="{{route('roles.edit', $role->id )}}"
                                       class="mr-1 focus:outline-none text-white bg-orange-700 hover:bg-orange-800 focus:ring-4 focus:ring-orange-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-orange-600 dark:hover:bg-orange-700 dark:focus:ring-orange-800">
